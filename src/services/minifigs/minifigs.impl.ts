...
class MinifigsService {
  apiUrl: string = import.meta.env.VITE_MINIFIGS_API
  authKey: string = import.meta.env.VITE_API_AUTHORIZATION_KEY
  ...
  async getMinifigs(params: GetMimifigsParams) {
    ...
    url.searchParams.append('in_theme_id', params.in_theme_id)
